...
begin
  ...
  if AHandle <> 0 then
  begin
    FMainViewClientInstance := LONG_PTR(System.Classes.MakeObjectInstance(ClientWndProcMainView));
  ...
  if AHandle <> 0 then
  begin
    FSubViewClientInstance := LONG_PTR(System.Classes.MakeObjectInstance(ClientWndProcSubView));
